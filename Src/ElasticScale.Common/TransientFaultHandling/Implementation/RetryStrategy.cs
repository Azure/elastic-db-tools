...
namespace Microsoft.Azure.SqlDatabase.ElasticScale
{
    ...
    internal partial class TransientFaultHandling
    {
        ...
        internal abstract class RetryStrategy
        {
            ...
            private static RetryStrategy defaultProgressive = new Incremental(DefaultClientRetryCount,
                DefaultRetryInterval, DefaultRetryIncrement);

            private static RetryStrategy defaultExponential = new ExponentialBackoff(DefaultClientRetryCount,
