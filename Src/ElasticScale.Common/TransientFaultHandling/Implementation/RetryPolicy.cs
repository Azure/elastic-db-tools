...
namespace Microsoft.Azure.SqlDatabase.ElasticScale
{
    ...
    internal partial class TransientFaultHandling
    {
        ...
        internal class RetryPolicy
        {
            ...
            private static RetryPolicy defaultProgressive = new RetryPolicy(new TransientErrorCatchAllStrategy(),
                RetryStrategy.DefaultProgressive);

            private static RetryPolicy defaultExponential = new RetryPolicy(new TransientErrorCatchAllStrategy(),
