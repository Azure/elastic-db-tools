    ...
    internal partial class TransientFaultHandling
    {
        ...
        internal enum ThrottledResourceType
        {
            ...
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming",
                "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "Io", Justification = "As designed")] LogWriteIoDelay = 2,

            /// <summary>
            /// Corresponds to the "Database Read IO Delay" resource, which may be subject to throttling.
            /// </summary>
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming",
                "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "Io", Justification = "As designed")] DataReadIoDelay = 3,
        ...
        internal class ThrottlingCondition
        {
            ...
            public bool IsThrottledOnDataSpace
            {
                ...
                {
                    return
                        this.throttledResources.Where(x => x.Item1 == ThrottledResourceType.PhysicalDatabaseSpace).Any();
                }
            }
            ...
            public bool IsThrottledOnLogSpace
            {
                get
                {
                    return this.throttledResources.Where(x => x.Item1 == ThrottledResourceType.PhysicalLogSpace).Any();
                }
            }
            ...
            public bool IsThrottledOnLogWrite
            {
                get
                {
                    return this.throttledResources.Where(x => x.Item1 == ThrottledResourceType.LogWriteIoDelay).Any();
                }
            }
            ...
            public bool IsThrottledOnDataRead
            {
                get
                {
                    return this.throttledResources.Where(x => x.Item1 == ThrottledResourceType.DataReadIoDelay).Any();
                }
            }
