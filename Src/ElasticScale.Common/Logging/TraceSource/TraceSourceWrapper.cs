...
{    
    ...
    internal class TraceSourceWrapper : ILogger
    {
        ...
        {
            m_traceSource = new TraceSource(traceSourceName);
        }
        ...
        {
            m_traceSource = new TraceSource(traceSourceName, defaultLevel);
        }
        ...
        {
            m_traceSource.TraceInformation(format, vars);
        }
        ...
        {
            m_traceSource.TraceEvent(TraceEventType.Verbose, 0, message);
        }
        ...
        {
            m_traceSource.TraceEvent(TraceEventType.Verbose, 0, format, vars);
        }
        ...
        {
            m_traceSource.TraceEvent(TraceEventType.Warning, 0, message);
        }
        ...
        {
            m_traceSource.TraceEvent(TraceEventType.Warning, 0, format, vars);
        }
        ...
        {
            m_traceSource.TraceEvent(TraceEventType.Warning, 0, "{0}. Encountered exception: {1}", message, exception);
        }
        ...
        public void Warning(Exception exception, string format, params object[] vars)
        {
            ...
            m_traceSource.TraceEvent(TraceEventType.Warning, 0, "{0}. Encountered exception: {1}", fmtMessage, exception);
        }
        ...
        {
            m_traceSource.TraceEvent(TraceEventType.Error, 0, message);
        }
        ...
        {
            m_traceSource.TraceEvent(TraceEventType.Error, 0, format, vars);
        }
        ...
        {
            m_traceSource.TraceEvent(TraceEventType.Error, 0, "{0}. Encountered exception: {1}", message, exception);
        }
        ...
        {
            string fmtMessage = string.Format(format, vars);
            m_traceSource.TraceEvent(TraceEventType.Error, 0, "{0}. Encountered exception: {1}", fmtMessage, exception);
        }
        ...
        {
            m_traceSource.TraceEvent(TraceEventType.Critical, 0, message);
        }
        ...
        {
            m_traceSource.TraceEvent(TraceEventType.Critical, 0, format, vars);
        }
        ...
        {
            m_traceSource.TraceEvent(TraceEventType.Critical, 0, "{0}. Exception encountered: {1}", message, exception);
        }
        ...
        {
            string fmtMessage = string.Format(format, vars);
            m_traceSource.TraceEvent(TraceEventType.Critical, 0, "{0}. Exception encountered: {1}", fmtMessage, exception);
        }
        ...
        {
            m_traceSource.TraceEvent(TraceEventType.Start, 0, "Start.{0}. ActivityId: {1}", method, activityId);
        }
        ...
        {
            m_traceSource.TraceEvent(TraceEventType.Stop, 0, "Stop.{0}. ActivityId: {1}", method, activityId);
        }
        ...
        {
            string fmtMessage = string.Format(format, vars);
            m_traceSource.TraceEvent(TraceEventType.Start, 0, "Start.{0}. {1}. ActivityId: {2}", method, fmtMessage, activityId);
        }
        ...
        {
            string fmtMessage = string.Format(format, vars);
            m_traceSource.TraceEvent(TraceEventType.Stop, 0, "Stop.{0}. {1}. ActivityId: {2}", method, fmtMessage, activityId);
        }
