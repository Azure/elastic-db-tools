...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.Query
{
    ...
    {
        private readonly ShardLocation m_shardLocation;
        ...
        protected MultiShardException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
            m_shardLocation = (ShardLocation)(info.GetValue("ShardLocation", typeof(ShardLocation)));
        }
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("ShardLocation", m_shardLocation);
        }
