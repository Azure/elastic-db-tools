...
//
// @File: MultiShardAggregateException.cs
//
// @Owner: raveeram
// @Test:
//
...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.Query
{
    ...
    public class MultiShardAggregateException : Exception
    {
        ...
        protected MultiShardAggregateException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
            m_innerExceptions = (ReadOnlyCollection<Exception>)(info.GetValue("InnerExceptions", typeof(ReadOnlyCollection<Exception>)));
        }
            ...
            : base(message, innerExceptions != null ? innerExceptions.FirstOrDefault() : null) 
        {
            ...
            m_innerExceptions = new ReadOnlyCollection<Exception>(exceptions);
        }
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("InnerExceptions", m_innerExceptions);
