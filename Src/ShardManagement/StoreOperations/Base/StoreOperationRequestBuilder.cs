...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement
{
    ...
    internal static class StoreOperationRequestBuilder
    {
        ...
        /// </summary>
        private static readonly XElement GsmVersion = new XElement("GsmVersion", 
        ...
        /// </summary>
        private static readonly XElement LsmVersion = new XElement("LsmVersion",
        ...
        internal static XElement FindAndUpdateOperationLogEntryByIdGlobal(Guid operationId, StoreOperationState undoStartState)
        {
            return new XElement(
                ...
                StoreOperationRequestBuilder.GsmVersion,
        ...
        internal static XElement GetAllShardsLocal()
        {
            return new XElement(
                @"GetAllShardsLocal",
                StoreOperationRequestBuilder.LsmVersion);
        }
