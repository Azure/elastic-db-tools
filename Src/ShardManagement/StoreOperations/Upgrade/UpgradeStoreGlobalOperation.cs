...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement
{
    ...
    /// </summary>
    class UpgradeStoreGlobalOperation : StoreOperationGlobal
    {
        /// <summary>
        ...
        public override IStoreResults DoGlobalExecute(IStoreTransactionScope ts)
        {
            ...
            if (checkResult.StoreVersion.Version < targetVersion)
            {
                DateTime createStartTime = DateTime.UtcNow;

                ts.ExecuteCommandBatch(SqlUtils.FilterUpgradeCommands(SqlUtils.UpgradeGlobalScript, targetVersion, checkResult.StoreVersion.Version));
