...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement
{
    ...
    /// </summary>
    class ReplaceMappingsOperation : StoreOperation
    {
        /// <summary>
        ...
        /// Original mappings.
        /// </summary>
        private Tuple<IStoreMapping, Guid>[] mappingsSource;

        /// <summary>
        /// New mappings.
        /// </summary>
        private Tuple<IStoreMapping, Guid>[] mappingsTarget;
        ...
        public override void HandleDoGlobalPreLocalExecuteError(IStoreResults result)
        {
            ...
            {
                foreach (IStoreMapping mappingSource in this.mappingsSource.Select(m => m.Item1))
                {
            ...
            throw StoreOperationErrorHandler.OnShardMapperErrorGlobal(
                result,
                this.shardMap,
                this.mappingsSource[0].Item1.StoreShard,
        ...
        public override IStoreResults DoLocalSourceExecute(IStoreTransactionScope ts)
        {
            return ts.ExecuteOperation(
                ...
                StoreOperationRequestBuilder.ReplaceShardMappingsLocal(
                    ...
                    false,
                    this.shardMap,
                    this.mappingsSource.Select(m => m.Item1).ToArray(),
                    this.mappingsTarget.Select(m => m.Item1).ToArray()));
        }
        ...
        {
            // Remove from cache.
            foreach (Tuple<IStoreMapping, Guid> ssm in this.mappingsSource)
            {
                this.Manager.Cache.DeleteMapping(ssm.Item1);
            }

            // Add to cache.
            foreach (Tuple<IStoreMapping, Guid> ssm in this.mappingsTarget)
            {
        ...
        public override IStoreResults UndoLocalSourceExecute(IStoreTransactionScope ts)
        {
            DefaultStoreShard dssOriginal = new DefaultStoreShard(
                this.mappingsSource[0].Item1.StoreShard.Id,
                this.OriginalShardVersionAdds,
                this.mappingsSource[0].Item1.ShardMapId,
                this.mappingsSource[0].Item1.StoreShard.Location,
                this.mappingsSource[0].Item1.StoreShard.Status);

            DefaultStoreMapping dsmSource = new DefaultStoreMapping(
                this.mappingsSource[0].Item1.Id,
                this.mappingsSource[0].Item1.ShardMapId,
                dssOriginal,
                this.mappingsSource[0].Item1.MinValue,
                this.mappingsSource[0].Item1.MaxValue,
                this.mappingsSource[0].Item1.Status,
                this.mappingsSource[0].Item2);

            DefaultStoreMapping dsmTarget = new DefaultStoreMapping(
                this.mappingsTarget[0].Item1.Id,
                this.mappingsTarget[0].Item1.ShardMapId,
                dssOriginal,
                this.mappingsTarget[0].Item1.MinValue,
                this.mappingsTarget[0].Item1.MaxValue,
                this.mappingsTarget[0].Item1.Status,
                this.mappingsTarget[0].Item2);
            ...
            return ts.ExecuteOperation(
                ...
                StoreOperationRequestBuilder.ReplaceShardMappingsLocal(
                    ...
                    true,
                    this.shardMap,
                    mt.Concat(this.mappingsTarget.Skip(1).Select(m => m.Item1)).ToArray(),
                    ms.Concat(this.mappingsSource.Skip(1).Select(m => m.Item1)).ToArray()));
        }
        ...
        protected override ShardLocation ErrorSourceLocation
        {
            get
            {
                return this.mappingsSource[0].Item1.StoreShard.Location;
            }
        }
