...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement
{
    ...
    /// </summary>
    class AddMappingOperation : StoreOperation
    {
        /// <summary>
            ...
            originalShardVersionAdds)
        {
            ...
            this.errorCategory = operationCode == StoreOperationCode.AddRangeMapping ?
        ...
        public override void DoGlobalPostLocalUpdateCache(IStoreResults result)
        {
            ...
            this.Manager.Cache.AddOrUpdateMapping(this.mapping, CacheStoreMappingUpdatePolicy.OverwriteExisting);
        }
