...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.StoreOperations.ShardMapper;
...
internal class LockOrUnLockMappingsGlobalOperation : StoreOperationGlobal
{
    ...
    /// Shard map to add.
    /// </summary>
    private readonly IStoreShardMap _shardMap;

    /// <summary>
    /// Mapping to lock or unlock.
    /// </summary>
    private readonly IStoreMapping _mapping;

    /// <summary>
    /// Lock owner id.
    /// </summary>
    private readonly Guid _lockOwnerId;

    /// <summary>
    /// Operation type.
    /// </summary>
    private readonly LockOwnerIdOpType _lockOpType;

    /// <summary>
    /// Error category to use.
    /// </summary>
    private readonly ShardManagementErrorCategory _errorCategory;
    ...
    /// </summary>
    protected override ShardManagementErrorCategory ErrorCategory => ShardManagementErrorCategory.ShardMap;
    ...
    {
        using var op = _shardMapManager.StoreOperationFactory.FromLogEntry(_shardMapManager, logEntry);
        op.Undo();
    }

    public override void HandleDoGlobalExecuteError(IStoreResults result) => throw new NotImplementedException();
    public override void HandleDoGlobalExecuteError(IStoreResults result) => throw new NotImplementedException();
}
