...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.StoreOperations.Recovery;
...
internal class DetachShardGlobalOperation : StoreOperationGlobal
{
    ...
    /// </summary>
    private readonly ShardLocation _location;
    ...
    /// </summary>
    protected override ShardManagementErrorCategory ErrorCategory => ShardManagementErrorCategory.Recovery;
}
