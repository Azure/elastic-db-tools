...
public class MockSqlDataReader : DbDataReader
{
    ...
    public MockSqlDataReader(string name)
        : this(name, new DataTable()) => Name = name;
    ...
    /// <summary>
    /// </summary>
    public override int VisibleFieldCount => throw new NotImplementedException();
    ...
    /// Not implemented
    /// </summary>
    public override Task<T> GetFieldValueAsync<T>(int ordinal, CancellationToken cancellationToken) => throw new NotImplementedException();
    ...
    /// Async DBNull
    /// </summary>
    public override Task<bool> IsDBNullAsync(int ordinal, CancellationToken cancellationToken) => throw new NotImplementedException();
    ...
    /// </summary>
    public override Task<bool> NextResultAsync(CancellationToken cancellationToken) => throw new NotImplementedException();
