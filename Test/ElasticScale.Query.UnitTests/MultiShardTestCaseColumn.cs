...
internal class MutliShardTestCaseColumn
{
    ...
    private MutliShardTestCaseColumn(string engineType, string columnTypeDeclaration, SqlDbType dbType, int fieldLength, string testColumnName)
    {
        ...
        ColumnTypeDeclaration = columnTypeDeclaration;
        DbType = dbType;
    ...
    /// </summary>
    public string SqlServerDatabaseEngineType { get; }
    ...
    /// them on the fly.
    /// </summary>
    public string ColumnTypeDeclaration { get; }
    ...
    /// </summary>
    public string TestColumnName { get; }

    /// <summary>
    /// Static helper to produce the $ShardName pseudo column for use in comparisons when testing.
    /// </summary>
    /// <returns></returns>
    private static MutliShardTestCaseColumn GenerateShardNamePseudoColumn() => new("nvarchar", "nvarchar(4000)", SqlDbType.NVarChar, 4000, "$ShardName");
    ...
    {
        var theColumns = new List<MutliShardTestCaseColumn>();
    ...
    {
        var colName = GenerateTestColumnName(sqlTypeName);
        var toAdd = new MutliShardTestCaseColumn(sqlTypeName, sqlFieldDeclarationText, dbType, length, colName);
    ...
    private static string GenerateTestColumnName(string sqlTypeName) => string.Format("Test_{0}_Field", sqlTypeName);
}
