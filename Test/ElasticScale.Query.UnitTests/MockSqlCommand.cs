...
public class MockSqlCommand : DbCommand, ICloneable
{
    ...
    public MockSqlCommand(int commandTimeout) => CommandTimeout = commandTimeout;
    ...
    /// <returns></returns>
    protected override DbDataReader ExecuteDbDataReader(CommandBehavior behavior) => ExecuteReaderFunc(CancellationToken.None, this);

    protected override Task<DbDataReader> ExecuteDbDataReaderAsync(CommandBehavior behavior, CancellationToken cancellationToken) => Task.Run<DbDataReader>(() =>
                                                                                                                                                  {
