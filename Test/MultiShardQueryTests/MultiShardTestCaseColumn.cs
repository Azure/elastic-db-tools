...
//
// @File: MutliShardTestCaseColumn.cs
//
// @Owner: errobins
// @Test:
//
...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.Query.UnitTests
{
    internal class MutliShardTestCaseColumn
    {
        ...
        /// </summary>
        private static IReadOnlyList<MutliShardTestCaseColumn> m_definedColumns;

        /// <summary>
        /// Private static memeber that holds our pseudo column.
        /// </summary>
        private static MutliShardTestCaseColumn m_shardNamePseudoColumn;

        /// <summary>
        /// Private immutable object member that holds the SqlServer engine type.
        /// </summary>
        private readonly string m_SqlServerDatabaseEngineType;

        /// <summary>
        /// The text column type declaration to use. 
        /// </summary>
        private readonly string m_columnTypeDeclaration;
        ...
        /// </summary>
        private readonly int m_fieldLength;

        /// <summary>
        /// The name to use when creating the column in the test database.
        /// </summary>
        private readonly string m_testColumnName;
        ...
        {
            m_SqlServerDatabaseEngineType = engineType;
            m_columnTypeDeclaration = columnTypeDeclaration;
            m_dbType = dbType;
            m_fieldLength = fieldLength;
            m_testColumnName = testColumnName;
        }
        ...
        { 
            get 
            {
                if (null == m_definedColumns)
                {
                    m_definedColumns = GenerateColumns();
                }
                return m_definedColumns; 
            } 
        }
        ...
        public static MutliShardTestCaseColumn ShardNamePseudoColumn
        {
            get
            {
                if (null == m_shardNamePseudoColumn)
                {
                    m_shardNamePseudoColumn = GenerateShardNamePseudoColumn();
                }
                return m_shardNamePseudoColumn;
            }
        }
        /// <summary>
        /// Public getter that exposes the SqlServer Engine data type name for this column.
        /// </summary>
        public string SqlServerDatabaseEngineType { get { return m_SqlServerDatabaseEngineType; } }
        ...
        /// them on the fly.
        /// </summary>
        public string ColumnTypeDeclaration { get { return m_columnTypeDeclaration; } }
        ...
        /// </summary>
        public int FieldLength { get { return m_fieldLength; } }
        ...
        /// </summary>
        public string TestColumnName { get { return m_testColumnName; } }
