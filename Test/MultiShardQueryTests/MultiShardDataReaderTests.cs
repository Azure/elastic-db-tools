...
//
// @File: MultiShardDataReaderTests.cs
//
// @Owner: errobins
// @Test:
//
...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.Query.UnitTests
{
    ...
    public class MultiShardDataReaderTests
    {
        ...
        private IEnumerable<SqlConnection> conns;
        ...
        /// </summary>
        private MultiShardCommand dummyCommand;
        ...
        public void MyTestInitialize()
        {
            ...
            this.shardConnection = new MultiShardConnection(sm.GetShards(), MultiShardTestUtils.ShardConnectionString);
            this.dummyCommand = MultiShardCommand.Create(this.shardConnection, "SELECT 1");
            ...
            //
            foreach (var conn in shardConnection.ShardConnections)
            {
                conn.Item2.Open();
            }

            this.conn1 = (SqlConnection)shardConnection.ShardConnections[0].Item2;
            this.conn2 = (SqlConnection)shardConnection.ShardConnections[1].Item2;
            this.conn3 = (SqlConnection)shardConnection.ShardConnections[2].Item2;
            this.conns = shardConnection.ShardConnections.Select(x => (SqlConnection) x.Item2);
        ...
        public void TestDataTableLoad()
        {
            ...
            using (MultiShardDataReader sdr = GetShardedDbReader(shardConnection, selectSql))
            {
        ...
        public void TestShardNamePseudoColumnOption()
        {
            ...
            foreach (bool pseudoColumnPresent in pseudoColumnPresentOptions) 
            {
                ...
                readers[0] = GetReader(this.conn1, selectSql);
                readers[1] = GetReader(this.conn2, selectSql);
                readers[2] = GetReader(this.conn3, selectSql);
        ...
        public void TestMismatchedSchemasWrongColumnName()
        {
            ...
            readers[0] = GetReader(this.conn1, selectSql);
            readers[1] = GetReader(this.conn2, alternateSelectSql);
        ...
        public void TestAddNullReader()
        {
            ...
            using (MultiShardDataReader sdr = new MultiShardDataReader(this.dummyCommand, readers, MultiShardExecutionPolicy.CompleteResults, true, 6))
            {
                sdr.AddReader(readers[0]);
...
SELECT dbNameField, Test_int_Field, Test_bigint_Field  FROM ConsistentShardedTable WHERE Test_int_Field = 876";
            ...
            MultiShardDataReader sdr = new MultiShardDataReader(this.dummyCommand, readers,
        ...
        public void TestAddDataReaderAfterShardedReaderIsClosed()
        {
            ...
            readers[0] = GetReader(this.conn1, selectSql);
            readers[1] = GetReader(this.conn2, selectSql);
            LabeledDbDataReader readerToAddAfterClose = GetReader(this.conn3, selectSql);

            using (MultiShardDataReader sdr = new MultiShardDataReader(this.dummyCommand, readers, MultiShardExecutionPolicy.CompleteResults, true, 5))
            {
                sdr.AddReader(readers[0]);
                sdr.AddReader(readers[1]);
                sdr.Close();
        ...
        public void TestReadsWhileReadersBeingAddedWithPartialResults()
        {
            ...
            using (MultiShardDataReader sdr = new MultiShardDataReader(this.dummyCommand, new LabeledDbDataReader[0], MultiShardExecutionPolicy.PartialResults, true, 1000))
            {
                for (int i = 0; i < 1000; i++)
                {
                    sdr.AddReader(GetReader(this.conn1, selectSql));
        ...
        public void TestAddClosedDataReaderAfterShardedReader()
        {
            ...
            readers[0] = GetReader(this.conn1, selectSql);
            readers[1] = GetReader(this.conn2, selectSql);
            LabeledDbDataReader closedReaderToAdd = GetReader(this.conn3, selectSql);
        ...
        public void TestAddDataReaderWhileReadingRows()
        {
            ...
            using (MultiShardDataReader sdr = new MultiShardDataReader(this.dummyCommand, readers, MultiShardExecutionPolicy.CompleteResults, true, 3))
            {
                ...
                Task.Factory.StartNew(() =>
                    {
                        ...
                        Thread.Sleep(TimeSpan.FromMilliseconds(500));
                        timesAdded.Add(DateTime.UtcNow);
                        sdr.AddReader(GetReader(this.conn2, selectSql));
                        Thread.Sleep(TimeSpan.FromMilliseconds(500));
                        timesAdded.Add(DateTime.UtcNow);
                        sdr.AddReader(GetReader(this.conn3, selectSql));
                    });
                int i = 0;
        ...
        public void TestAddDataReaderWaitsALongTimeForExpectedReadersUntilExpectNoMoreReadersIsCalled()
        {
            ...
            using (MultiShardDataReader sdr = new MultiShardDataReader(this.dummyCommand, readers, MultiShardExecutionPolicy.CompleteResults, true, 4))
            {
        ...
        public void TestAddDataReadersConcurrently()
        {
            ...
            IEnumerable<LabeledDbDataReader> readers = this.conns.Select((x) => GetReader(x, selectSql));

            using (MultiShardDataReader sdr = new MultiShardDataReader(this.dummyCommand, empty, MultiShardExecutionPolicy.CompleteResults, true, 3))
            {
        ...
        private void TestGettersPositiveCasesHelper(bool includeShardNamePseudoColumn)
        {
            ...
            foreach (MutliShardTestCaseColumn curCol in toCheck)
            {
                ...
                using (MultiShardDataReader sdr = GetShardedDbReader(shardConnection, selectSql, includeShardNamePseudoColumn))
                {
                    int recordsRetrieved = 0;
