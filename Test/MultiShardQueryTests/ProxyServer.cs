...
// \\cpvsbuild\drops\dev11\Main\raw\51101.00\sources\QA\DevDiv\dptest\Data\Common\Src\Utils\ProxyServer.cs 
//******************************************************************************
...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.Query.UnitTests
{
    ...
    public class ProxyServer : IDisposable
    {
        ...
        private StringBuilder _eventLog = new StringBuilder(_logHeader, 1000);
        private static string _logHeader = "======== ProxyServer Log Start ========\n";
        private static string _logTrailer = "======== ProxyServer Log End ========\n";
