...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.UnitTests
{
    ...
    public class ShardMapManagerTests
    {
        ...
        public void GetShardMapsDefault()
        {
            ...
            ShardMap sm = smm.CreateListShardMap<int>(ShardMapManagerTests.ShardMapName);

            Assert.IsNotNull(sm);

            Assert.AreEqual(ShardMapManagerTests.ShardMapName, sm.Name);
        ...
        public void CreateListShardMapDefault()
        {
            ...
            ListShardMap<int> lsm = smm.CreateListShardMap<int>(ShardMapManagerTests.ShardMapName);

            Assert.IsNotNull(lsm);

            ShardMap smLookup = smm.LookupShardMapByName("LookupShardMapByName", ShardMapManagerTests.ShardMapName, true);
            Assert.IsNotNull(smLookup);
            Assert.AreEqual(ShardMapManagerTests.ShardMapName, smLookup.Name);
            Assert.AreEqual(1, cacheStore.LookupShardMapCount);
            Assert.AreEqual(1, cacheStore.LookupShardMapHitCount);
        }
        ...
        public void CreateRangeShardMapDefault()
        {
            ...
            RangeShardMap<int> rsm = smm.CreateRangeShardMap<int>(ShardMapManagerTests.ShardMapName);

            Assert.IsNotNull(rsm);
            Assert.AreEqual(ShardMapManagerTests.ShardMapName, rsm.Name);
        ...
        public void CreateRangeShardMapDuplicate()
        {
            ...
            ShardMap sm = smm.CreateRangeShardMap<int>(ShardMapManagerTests.ShardMapName);
        ...
        public void CreateListShardMapAbortGSM()
        {
            ...
            try
            {
                ListShardMap<int> lsm = smm.CreateListShardMap<int>(ShardMapManagerTests.ShardMapName);
                Assert.IsNotNull(lsm);
                Assert.AreEqual(ShardMapManagerTests.ShardMapName, lsm.Name);
            }
            catch (ShardManagementException sme)
            {
                Assert.AreEqual(ShardManagementErrorCategory.ShardMapManager, sme.ErrorCategory);
