...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.UnitTests
{
    ...
    public class RecoveryManagerTests
    {
        ...
        /// </summary>
        private static string[] GsmTables = new[]
        {
        ...
        /// </summary>
        private static string[] LsmTables = new[]
        {
        ...
        private static void CreateShardMapsHelper()
        {
            ...
            ListShardMap<int> lsm = smm.CreateListShardMap<int>(RecoveryManagerTests.ListShardMapName);

            Assert.IsNotNull(lsm);

            Assert.AreEqual(RecoveryManagerTests.ListShardMapName, lsm.Name);

            // Create range shard map.
            RangeShardMap<int> rsm = smm.CreateRangeShardMap<int>(RecoveryManagerTests.RangeShardMapName);

            Assert.IsNotNull(rsm);

            Assert.AreEqual(RecoveryManagerTests.RangeShardMapName, rsm.Name);
        }
        ...
        private static void CleanTablesHelper()
        {
            using (SqlConnection conn = new SqlConnection(Globals.ShardMapManagerTestConnectionString))
            {
                ...
                // Clean LSM tables.
                foreach (string dbName in RecoveryManagerTests.ShardedDBs)
                {
                    foreach (string tableName in LsmTables)
                    {
                ...
                // Clean GSM tables
                foreach (string tableName in GsmTables)
                {
                    using (SqlCommand cmd = new SqlCommand(
        ...
        public static void RecoveryManagerTestsInitialize(TestContext testContext)
        {
            ...
            using (SqlConnection conn = new SqlConnection(Globals.ShardMapManagerTestConnectionString))
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand(
                        string.Format(Globals.DropDatabaseQuery, RecoveryManagerTests.ShardedDBs[i]),
                        conn))
                    {
                        cmd.ExecuteNonQuery();
                    }
                    ...
                    using (SqlCommand cmd = new SqlCommand(
                        string.Format(Globals.CreateDatabaseQuery, RecoveryManagerTests.ShardedDBs[i]),
                        conn))
                    {
                        cmd.ExecuteNonQuery();
                    }
        ...
        public void TestDetachAttachShard()
        {
            ...
            RangeShardMap<int> rsm = smm.GetRangeShardMap<int>(RecoveryManagerTests.RangeShardMapName);

            Assert.IsNotNull(rsm);

            ShardLocation sl = new ShardLocation(Globals.ShardMapManagerTestsDatasourceName, RecoveryManagerTests.ShardedDBs[0]);
        ...
        public void TestConsistencyDetectionOnListMapping()
        {
            ...
            ListShardMap<int> rsm = smm.GetListShardMap<int>(RecoveryManagerTests.ListShardMapName);
        ...
        public void TestConsistencyDetectionWithDivergence()
        {
            ...
            ShardLocation sl1 = new ShardLocation(Globals.ShardMapManagerTestsDatasourceName, RecoveryManagerTests.ShardedDBs[0]);
            ShardLocation sl2 = new ShardLocation(Globals.ShardMapManagerTestsDatasourceName, RecoveryManagerTests.ShardedDBs[1]);
        ...
        public void TestRestoreGSMFromLSMsList()
        {
            ...
            var lsm = smm.GetListShardMap<int>(RecoveryManagerTests.ListShardMapName);
        ...
        public void TestRebuildShardFromGSMList()
        {
            ...
            ListShardMap<int> lsm = smm.GetListShardMap<int>(RecoveryManagerTests.ListShardMapName);
        ...
        public void TestPointMappingRecoverFromLSM()
        {
            ...
            ListShardMap<int> listsm = smm.GetListShardMap<int>(RecoveryManagerTests.ListShardMapName);
        ...
        public void TestGeoFailoverAttach()
        {
            ...
            ShardLocation sl = new ShardLocation(Globals.ShardMapManagerTestsDatasourceName, RecoveryManagerTests.ShardedDBs[0]);
            ShardLocation slNew = new ShardLocation(Globals.ShardMapManagerTestsDatasourceName, RecoveryManagerTests.ShardedDBs[0] + "_new");
