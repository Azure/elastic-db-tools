...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.UnitTests
{
    ...
    public class ShardMapManagerConcurrencyTests
    {
        ...
        public void ShardMapManagerConcurrencyTestInitialize()
        {
            ...
            try
            {
                ShardMap sm = smm.GetShardMap(ShardMapManagerConcurrencyTests.ShardMapName);
        ...
        public void ConcurrencyScenarioListShardMap()
        {
            ...
            ShardMap smMgmt = smmMgmt.CreateListShardMap<int>(ShardMapManagerConcurrencyTests.ShardMapName);

            Assert.AreEqual(ShardMapManagerConcurrencyTests.ShardMapName, smMgmt.Name);

            // Lookup shard map from client SMM.
            ShardMap smClient = smmClient.GetShardMap(ShardMapManagerConcurrencyTests.ShardMapName);
            ...
            ListShardMap<int> lsmMgmt = smmMgmt.GetListShardMap<int>(ShardMapManagerConcurrencyTests.ShardMapName);
            Assert.IsNotNull(lsmMgmt);

            // look up shard map again, it will 
            ListShardMap<int> lsmClient = smmClient.GetListShardMap<int>(ShardMapManagerConcurrencyTests.ShardMapName);
