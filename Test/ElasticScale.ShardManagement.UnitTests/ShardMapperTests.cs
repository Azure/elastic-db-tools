...
public class ShardMapperTests
{
    ...
    private static void CleanShardMapsHelper()
    {
        ...
        if (smm.TryGetListShardMap<int>(ShardMapperTests.s_listShardMapName, out var lsm))
        {
        ...
        if (smm.TryGetRangeShardMap<int>(ShardMapperTests.s_rangeShardMapName, out var rsm))
        {
    ...
    public static void ShardMapperTestsInitialize(TestContext testContext)
    {
        ...
        using (var conn = new SqlConnection(Globals.ShardMapManagerTestConnectionString))
        {
            ...
            for (var i = 0; i < ShardMapperTests.s_shardedDBs.Length; i++)
            {
                using (var cmd = new SqlCommand(
        ...
        var lsm = smm.CreateListShardMap<int>(ShardMapperTests.s_listShardMapName);
        ...
        var rsm = smm.CreateRangeShardMap<int>(ShardMapperTests.s_rangeShardMapName);
    ...
    /// </summary>
    [TestInitialize()]
    public void ShardMapperTestInitialize() => ShardMapperTests.CleanShardMapsHelper();

    /// <summary>
    /// Cleans up common state per-test.
    /// </summary>
    [TestCleanup()]
    public void ShardMapperTestCleanup() => ShardMapperTests.CleanShardMapsHelper();
    ...
    public void ShardMapTypeFailures()
    {
        ...
        try
        {
            var rsm = smm.GetRangeShardMap<int>(ShardMapperTests.s_listShardMapName);
        ...
        try
        {
            var lsm = smm.GetListShardMap<int>(ShardMapperTests.s_rangeShardMapName);
        ...
        try
        {
            var lsm = smm.GetListShardMap<Guid>(ShardMapperTests.s_listShardMapName);
            Assert.Fail("GetListShardMap did not throw as expected");
        }
        catch (ShardManagementException sme)
        {
        ...
        try
        {
            var rsm = smm.GetRangeShardMap<long>(ShardMapperTests.s_rangeShardMapName);
            Assert.Fail("GetRangeshardMap did not throw as expected");
        }
        catch (ShardManagementException sme)
        {
        ...
        try
        {
            var lsm = smm.GetListShardMap<Guid>(ShardMapperTests.s_rangeShardMapName);
            Assert.Fail("GetListShardMap did not throw as expected");
        }
        catch (ShardManagementException sme)
        {
    ...
    private void AddPointMappingDefault<T>(IEnumerable<T> keysToTest)
    {
        ...
        var lsm = smm.CreateListShardMap<T>(string.Format("AddPointMappingDefault_{0}", typeof(T).Name));
        Assert.IsNotNull(lsm);

        var sl = new ShardLocation(Globals.ShardMapManagerTestsDatasourceName, ShardMapperTests.s_shardedDBs[0]);
        ...
        foreach (var key in keysToTest)
        {
            ...
            var p2 = lsm.GetMappingForKey(key);
            Assert.IsNotNull(p2);
            ...
            using var conn = lsm.OpenConnection(
                p1,
    ...
    [TestMethod()]
    [TestCategory("ExcludeFromGatedCheckin")]
    public void GetPointMappingForKey_Ex() => GetPointMappingForKey(new ExceptionBasedTestShardMapVerifier());

    [TestMethod()]
    [TestCategory("ExcludeFromGatedCheckin")]
    public void GetPointMappingForKey_Try() => GetPointMappingForKey(new TryBasedTestShardMapVerifier());
    ...
    private void GetPointMappingForKey(TestShardMapVerifier verifier)
    {
        ...
        var lsm = new TestShardMap<int>(smm.GetListShardMap<int>(ShardMapperTests.s_listShardMapName));
        var lsm2 = new TestShardMap<int>(smm2.GetListShardMap<int>(ShardMapperTests.s_listShardMapName));
    ...
    public void GetPointMappingsForRange()
    {
        ...
        var lsm = smm.GetListShardMap<int>(ShardMapperTests.s_listShardMapName);

        Assert.IsNotNull(lsm);

        var s1 = lsm.CreateShard(new ShardLocation(Globals.ShardMapManagerTestsDatasourceName, ShardMapperTests.s_shardedDBs[0]));
        Assert.IsNotNull(s1);

        var s2 = lsm.CreateShard(new ShardLocation(Globals.ShardMapManagerTestsDatasourceName, ShardMapperTests.s_shardedDBs[1]));
        Assert.IsNotNull(s2);

        var p1 = lsm.CreatePointMapping(1, s1);
        Assert.IsNotNull(p1);

        var p2 = lsm.CreatePointMapping(10, s1);
        Assert.IsNotNull(p2);
        _ = lsm.CreatePointMapping(5, s2);
        Assert.IsNotNull(p2);
    ...
    public void AddPointMappingDuplicate()
    {
        ...
        var p1 = lsm.CreatePointMapping(1, s);
        ...
        try
        {
            ...
            var pNew = lsm.CreatePointMapping(1, s);
        }
        catch (ShardManagementException sme)
        {
    ...
    public void DeletePointMappingDefault()
    {
        ...
        try
        {
            var pLookup = lsm.GetMappingForKey(1);
        }
        catch (ShardManagementException sme)
        {
            Assert.AreEqual(ShardManagementErrorCategory.ListShardMap, sme.ErrorCategory);
    ...
    public void DeletePointMappingVersionMismatch()
    {
        ...
        var pNew = lsm.UpdateMapping(p1, pu);
    ...
    public void UpdatePointMappingDefault()
    {
        ...
        var pUpdated = lsm.UpdateMapping(pNew, pu);
    ...
    public void KillConnectionOnOfflinePointMapping()
    {
        ...
        using var conn = lsm.OpenConnectionForKeyAsync(1, Globals.ShardUserConnectionString).Result;
        ...
        try
        {
            using var conn2 = lsm.OpenConnectionForKeyAsync(1, Globals.ShardUserConnectionString).Result;
        }
        catch (AggregateException ex)
        {
            if (ex.InnerException is ShardManagementException sme)
            {
                failed = true;
        ...
        try
        {
            using var conn3 = lsm.OpenConnectionForKey(1, Globals.ShardUserConnectionString);
        }
    ...
    public void UpdatePointMappingLocation()
    {
        ...
        var pu = new PointMappingUpdate
        {
            Status = MappingStatus.Offline // Shard location in a mapping cannot be changed unless it is offline.
        };

        var pOffline = lsm.UpdateMapping(p1, pu);

        Assert.IsNotNull(pOffline);
        Assert.AreEqual(pu.Status, pOffline.Status);
        pu.Shard = s2;

        var pNew = lsm.UpdateMapping(pOffline, pu);
        Assert.IsNotNull(pNew);
    ...
    public void UpdatePointMappingIdempotency()
    {
        ...
        var presult = lsm.UpdateMapping(p1, pu);
    ...
    private void AddRangeMappingDefault<T>(IList<T> keysToTest)
    {
        ...
        var rsm = smm.CreateRangeShardMap<T>(string.Format("AddRangeMappingDefault_{0}", typeof(T).Name));
        Assert.IsNotNull(rsm);

        var sl = new ShardLocation(Globals.ShardMapManagerTestsDatasourceName, ShardMapperTests.s_shardedDBs[0]);
        var s = rsm.CreateShard(sl);
        Assert.IsNotNull(s);

        for (var i = 0; i < keysToTest.Count - 1; i++)
        {
            ...
            var range = new Range<T>(keysToTest[i], keysToTest[i + 1]);
            Console.WriteLine("Range: {0}", range);

            var p1 = rsm.CreateRangeMapping(range, s);
            Assert.IsNotNull(p1);
            AssertExtensions.AssertScalarOrSequenceEqual(range, p1.Value);

            var p2 = rsm.GetMappingForKey(range.Low);
            Assert.IsNotNull(p2);
            ...
            // Validate mapping by trying to connect
            using var conn = rsm.OpenConnection(
                p1,
                Globals.ShardUserConnectionString,
                ConnectionOptions.Validate);
        }
    ...
    public void AddRangeMappingMultiple()
    {
        ...
        var rsm = smm.GetRangeShardMap<int>(ShardMapperTests.s_rangeShardMapName);
        ...
        var r1 = rsm.CreateRangeMapping(new Range<int>(0, 10), s);
        Assert.IsNotNull(r1);

        var r2 = rsm.CreateRangeMapping(new Range<int>(20, 30), s);
        Assert.IsNotNull(r2);

        var addFailed = false;

        var ranges = new int[6, 2] { { 5, 15 }, { 5, 7 }, { -5, 5 }, { -5, 15 }, { 15, 25 }, { int.MinValue, int.MaxValue } };
        ...
        for (var i = 0; i < 6; i++)
        {
            ...
            {
                addFailed = false;
                var r3 = rsm.CreateRangeMapping(new Range<int>(ranges[i, 0], ranges[i, 1]), s);
            }
            catch (ShardManagementException sme)
            {
        ...
        var r4 = rsm.CreateRangeMapping(new Range<int>(10, 20), s);
        Assert.IsNotNull(r4);
    }
    ...
    public void TestEquatableForShards()
    {
        ...
        var sl1 = new ShardLocation(Globals.ShardMapManagerTestsDatasourceName, ShardMapperTests.s_shardedDBs[0]);

        var sl2 = new ShardLocation(Globals.ShardMapManagerTestsDatasourceName, ShardMapperTests.s_shardedDBs[1]);

        var s1 = rsm.CreateShard(sl1);
        Assert.IsNotNull(s1);

        var s2 = rsm.CreateShard(sl2);
        Assert.IsNotNull(s2);


        var r1 = rsm.CreateRangeMapping(new Range<int>(0, 10), s1);
        Assert.IsNotNull(r1);

        var r2 = rsm.CreateRangeMapping(new Range<int>(10, 20), s2);
        Assert.IsNotNull(r2);

        var r3 = rsm.CreateRangeMapping(new Range<int>(20, 30), s1);
        Assert.IsNotNull(r3);

        var sLookup = rsm.GetMappingForKey(5).Shard;

        Assert.IsFalse(sLookup.Equals(s1));

        Assert.IsFalse(sLookup.Equals(s2));

        var myShardSelection = rsm
    ...
    public void AddRangeMappingEntireRange()
    {
        ...
        var r1 = rsm.CreateRangeMapping(new Range<int>(int.MinValue), s);
    ...
    public void AddRangeMappingTestBoundaries()
    {
        ...
        for (var i = 0; i < 3; i++)
        {
            var r = rsm.CreateRangeMapping(new Range<int>(ranges[i, 0], ranges[i, 1]), s);
            Assert.IsNotNull(r);
        }

        // Add range [2147483647, +inf). This range is actually representing a single point int.MaxValue
        var r1 = rsm.CreateRangeMapping(new Range<int>(int.MaxValue), s);
        Assert.IsNotNull(r1);
    }
    ...
    public void AddRangeMappingDuplicate()
    {
        ...
        var exception = AssertExtensions.AssertThrows<ShardManagementException>
    ...
    public void DeleteRangeMappingDefault()
    {
        ...
        var rLookup = rsm.GetMappingForKey(1);
        ...
        var mappingToDelete = rsm.UpdateMapping(r1, ru, mappingLockToken);
    ...
    public void DeleteRangeMappingVersionMismatch()
    {
        ...
        var rNew = rsm.UpdateMapping(r1, ru);
    ...
    public void UpdateRangeMappingDefault()
    {
        ...
        var r1 = rsm.CreateRangeMapping(new Range<int>(1, 20), s);
        ...
        var rNew = rsm.UpdateMapping(r1, ru, mappingLockToken);

        Assert.IsNotNull(rNew);

        var storeMappingLockToken = rsm.GetMappingLockOwner(rNew);
    ...
    public void KillConnectionOnOfflineRangeMapping()
    {
        ...
        using var conn = rsm.OpenConnectionForKeyAsync(1, Globals.ShardUserConnectionString).Result;
        Assert.AreEqual(ConnectionState.Open, conn.State);
        ...
        try
        {
            using var conn2 = rsm.OpenConnectionForKeyAsync(1, Globals.ShardUserConnectionString).Result;
        }
        catch (AggregateException ex)
        {
            if (ex.InnerException is ShardManagementException sme)
        ...
        var rUpdated = rsm.UpdateMapping(rNew, ru);
        ...
        try
        {
            using var conn3 = rsm.OpenConnectionForKey(1, Globals.ShardUserConnectionString);
        }
        catch (ShardManagementException)
        {
            failed = true;
    ...
    public void UpdateRangeMappingLocation()
    {
        ...
        var r1 = rsm.CreateRangeMapping(new Range<int>(1, 20), s1);
        ...
        var rOffline = rsm.UpdateMapping(r1, ru);

        Assert.IsNotNull(rOffline);
        Assert.AreEqual(ru.Status, rOffline.Status);
        ru.Shard = s2;

        var rNew = rsm.UpdateMapping(rOffline, ru);
        Assert.IsNotNull(rNew);
    ...
    public void UpdateRangeMappingIdempotency()
    {
        ...
        var s1 = rsm.CreateShard(new ShardLocation(Globals.ShardMapManagerTestsDatasourceName, ShardMapperTests.s_shardedDBs[0]));
        Assert.IsNotNull(s1);

        var s2 = rsm.CreateShard(new ShardLocation(Globals.ShardMapManagerTestsDatasourceName, ShardMapperTests.s_shardedDBs[1]));
        Assert.IsNotNull(s2);

        var r1 = rsm.CreateRangeMapping(new Range<int>(1, 20), s1);

        // Online -> Offline - No Location Change
        var pu = new RangeMappingUpdate
        {
            Status = MappingStatus.Offline
        };

        var presult = rsm.UpdateMapping(r1, pu);
        Assert.IsNotNull(presult);
        Assert.IsTrue(presult.Status == MappingStatus.Offline);
    ...
    [TestMethod()]
    [TestCategory("ExcludeFromGatedCheckin")]
    public void GetRangeMappingForKey_Ex() => GetRangeMappingForKey(new ExceptionBasedTestShardMapVerifier());

    [TestMethod()]
    [TestCategory("ExcludeFromGatedCheckin")]
    public void GetRangeMappingForKey_Try() => GetRangeMappingForKey(new TryBasedTestShardMapVerifier());
    ...
    private void GetRangeMappingForKey(TestShardMapVerifier verifier)
    {
        ...
        var rsm = new TestShardMap<int>(smm.GetRangeShardMap<int>(ShardMapperTests.s_rangeShardMapName));
        var rsm2 = new TestShardMap<int>(smm2.GetRangeShardMap<int>(ShardMapperTests.s_rangeShardMapName));
    ...
    public void SplitRangeDefault()
    {
        ...
        var rList = rsm.SplitMapping(r1, 5, mappingLockToken);
    ...
    public void SplitRangeBoundary()
    {
        ...
        var exception = AssertExtensions.AssertThrows<ArgumentOutOfRangeException>
    ...
    public void MergeRangeMappingsDefault()
    {
        ...
        var r2 = rsm.CreateRangeMapping(new Range<int>(10, 20), s1);
        ...
        var rMerged = rsm.MergeMappings(r1, r2, mappingLockTokenLeft, mappingLockTokenRight);
    ...
    public void MergeRangeMappingsDifferentLocation()
    {
        ...
        var exception = AssertExtensions.AssertThrows<ArgumentException>
            (() => rsm.MergeMappings(r1, r2));
    }
    ...
    public void MergeRangeMappingsNonAdjacent()
    {
        ...
        var r2 = rsm.CreateRangeMapping(new Range<int>(15, 20), s1);
    ...
    public void LockOrUnlockRangeMappingBasic()
    {
        ...
        var argException = AssertExtensions.AssertThrows<ArgumentException>
        ...
        var r1LookUp = rsm.GetMappingForKey(5);
    ...
    public void LockOrUnlockListMappingBasic()
    {
        ...
        var rsm = smm.GetListShardMap<int>(ShardMapperTests.s_listShardMapName);
        ...
        // Create a range mapping
        var r1 = rsm.CreatePointMapping(1, s1);
        ...
        // Lookup should work without a lockownerId
        var r1LookUp = rsm.GetMappingForKey(1);
        Assert.AreEqual(r1, r1LookUp, "Expected range mappings to be equal!");
    ...
    public void UnlockAllMappingsWithLockOwnerId()
    {
        ...
        var mappings = new List<RangeMapping<int>>();
        var mappingLockToken = MappingLockToken.Create();

        for (var i = 0; i < 100; i += 10)
        {
            var mapping = rsm.CreateRangeMapping(new Range<int>(i, i + 10), s1);
    ...
    public void UnlockAllMappingsListMapWithLockOwnerId()
    {
        ...
        // Create a few mappings and lock some of them
        var mappings = new List<PointMapping<int>>();
        var mappingLockToken = MappingLockToken.Create();

        for (var i = 0; i < 100; i += 10)
        {
            var mapping = rsm.CreatePointMapping(i, s1);
            mappings.Add(mapping);
    ...
    private static void GetMappingForKey(TestShardMap<int> lsm, TestShardMap<int> lsm2, TestShardMapVerifier verifier)
    {
        ...
        var s1 = lsm.ShardMap.CreateShard(new ShardLocation(Globals.ShardMapManagerTestsDatasourceName,
            ShardMapperTests.s_shardedDBs[0]));
        Assert.IsNotNull(s1);

        var s2 = lsm.ShardMap.CreateShard(new ShardLocation(Globals.ShardMapManagerTestsDatasourceName,
            ShardMapperTests.s_shardedDBs[1]));
        Assert.IsNotNull(s2);

        // Create point mapping via lsm
        var p1 = lsm.CreateMapping(1, 2, s1);
        Assert.IsNotNull(p1);

        // Get mapping from cache - it should be in lsm cache, but not in lsm2 cache
        var cache1 = verifier.GetMappingForKey(lsm, 1, LookupOptions.LookupInCache);
        ...
        var cacheThenStorage1 = verifier.GetMappingForKey(lsm, 1);
        Assert.AreEqual(p1, cacheThenStorage1);

        var cacheThenStorage2 = verifier.GetMappingForKey(lsm2, 1);
        Assert.AreEqual(p1, cacheThenStorage2);

        // Verify that it is now loaded in lsm2 cache
        var cache2 = verifier.GetMappingForKey(lsm2, 1, LookupOptions.LookupInCache);
        Assert.IsNotNull(cache2);
        Assert.AreEqual(p1, cache2);

        // Delete mapping via lsm
        var p1Offline = lsm.MarkMappingOffline(p1);
        ...
        var staleCache2 = verifier.GetMappingForKey(lsm2, 1, LookupOptions.LookupInCache | LookupOptions.LookupInStore);
    ...
    public void MarkMappingOfflineOnline()
    {
        ...
        var pNew = lsm.MarkMappingOffline(p1);
        ...
        var r1 = rsm.CreateRangeMapping(new Range<int>(1, 5), s);

        var rNew = rsm.MarkMappingOffline(r1);
    ...
    public void MarkMappingOfflineOnlineWithMappingOptions()
    {
        ...
        var pNew = lsm.MarkMappingOffline(p1, MappingOptions.None);
        ...
        var rNew = rsm.MarkMappingOffline(r1, MappingLockToken.NoLock, MappingOptions.None);
    ...
    [TestMethod()]
    [TestCategory("ExcludeFromGatedCheckin")]
    public void UnavailableServerOpenConnectionForKeyListShardMap() => UnavailableServerOpenConnectionForKeyListShardMapInternal();
    ...
    [TestMethod()]
    [TestCategory("ExcludeFromGatedCheckin")]
    public void UnavailableServerOpenConnectionForKeyAsyncListShardMap() => UnavailableServerOpenConnectionForKeyListShardMapInternal(openConnectionAsync: true);
    ...
    private void UnavailableServerOpenConnectionForKeyListShardMapInternal(bool openConnectionAsync = false)
    {
        ...
        IStoreOperationFactory sof = new StubStoreOperationFactory()
        {
            ...
            {
                var op = new StubFindMappingByKeyGlobalOperation(_smm, _opname, _ssm, _sk, _pol, _ec, _cr, _if)
                {
                    CallBase = true
                };
        ...
        var sics = new StubICacheStoreMapping
        {
        ...
        for (var i = 1; i <= 10; i++)
        {
            _ = Assert.ThrowsException<SqlException>(() =>
            {
        ...
        var currentTtl = ((ICacheStoreMapping)sics).TimeToLiveMilliseconds;
    ...
    [TestMethod()]
    [TestCategory("ExcludeFromGatedCheckin")]
    public void UnavailableServerOpenConnectionForKeyRangeShardMap() => UnavailableServerOpenConnectionForKeyRangeShardMapInternal();
    ...
    [TestMethod()]
    [TestCategory("ExcludeFromGatedCheckin")]
    public void UnavailableServerOpenConnectionForKeyAsyncRangeShardMap() => UnavailableServerOpenConnectionForKeyRangeShardMapInternal(openConnectionAsync: true);
    ...
    private void UnavailableServerOpenConnectionForKeyRangeShardMapInternal(bool openConnectionAsync = false)
    {
        ...
        var r1 = rsm.CreateRangeMapping(new Range<int>(5, 20), s);
        Assert.IsNotNull(r1);
    ...
    public void AddPointMappingAbortGSM()
    {
        ...
        IStoreOperationFactory sof = new StubStoreOperationFactory()
        {
            ...
            {
                var op = new StubAddMappingOperation(_smm, _opcode, _ssm, _sm)
                {
                    CallBase = true
                };
        ...
        var p2 = lsm.CreatePointMapping(2, s);
        Assert.IsNotNull(p2);
    }
    ...
    public void DeletePointMappingAbortGSM()
    {
        IStoreOperationFactory sof = new StubStoreOperationFactory()
        {
            ...
            {
                var op = new StubRemoveMappingOperation(_smm, _opcode, _ssm, _sm, _loid)
                {
                    CallBase = true,
                    DoGlobalPostLocalExecuteIStoreTransactionScope = (ts) =>
                    {
                        throw new StoreException("", ShardMapFaultHandlingTests.TransientSqlException);
                    }
                };
        ...
        var pmOffline = lsm.MarkMappingOffline(p1);
        Assert.IsNotNull(pmOffline);
        ...
        var pNew = lsm.GetMappingForKey(1);
        Assert.IsNotNull(pNew);
    }
    ...
    public void UpdatePointMappingAbortGSM()
    {
        IStoreOperationFactory sof = new StubStoreOperationFactory()
        {
            ...
            {
                var op = new StubUpdateMappingOperation(_smm, _opcode, _ssm, _sms, _smt, _p, _loid, _kc)
                {
                    CallBase = true,
                    DoGlobalPostLocalExecuteIStoreTransactionScope = (ts) =>
                    {
        ...
        var pValidate = lsm.GetMappingForKey(1);
    ...
    public void UpdatePointMappingLocationAbortGSM()
    {
        ...
        var pu1 = new PointMappingUpdate
        {
            // Take the mapping offline first before the shard location can be updated.
            Status = MappingStatus.Offline
        };
        var pNew = lsm.UpdateMapping(p1, pu1);

        var pu2 = new PointMappingUpdate()
        {
            Shard = s2
        };
    ...
    public void AddRangeMappingAbortGSM()
    {
        ...
        var rValidate = rsm.CreateRangeMapping(new Range<int>(1, 10), s);
    ...
    public void DeleteRangeMappingAbortGSM()
    {
        ...
        var rValidate = rsm.GetMappingForKey(5);
        Assert.IsNotNull(rValidate);
    ...
    public void UpdateRangeMappingAbortGSM()
    {
        ...
        var rValidate = rsm.GetMappingForKey(1);
    ...
    public void UpdateRangeMappingLocationAbortGSM()
    {
        ...
        var ru1 = new RangeMappingUpdate
        {
            // Take the mapping offline first.
            Status = MappingStatus.Offline
        };
        var rNew = rsm.UpdateMapping(r1, ru1);
        Assert.IsNotNull(rNew);

        var ru2 = new RangeMappingUpdate
        {
            Shard = s2
        };
    ...
    public void SplitRangeAbortGSM()
    {
        IStoreOperationFactory sof = new StubStoreOperationFactory()
        {
            ...
            {
                var op = new StubReplaceMappingsOperation(_smm, _opcode, _ssm, _smo, _smn)
                {
                    CallBase = true,
                    DoGlobalPostLocalExecuteIStoreTransactionScope = (ts) =>
                    {
        ...
        try
        {
            var rList = rsm.SplitMapping(r1, 5);
            Assert.AreEqual(2, rList.Count);
        }
        catch (ShardManagementException sme)
        {
    ...
    public void MergeRangeMappingsAbortGSM()
    {
        ...
        try
        {
            var rMerged = rsm.MergeMappings(r1, r2);
            Assert.IsNotNull(rMerged);
        }
        catch (ShardManagementException sme)
        {
    ...
    public void DeletePointMappingAbortLSM()
    {
        IStoreOperationFactory sof = new StubStoreOperationFactory()
        {
            ...
            (_smm, _opcode, _ssm, _sm, _loid) =>
            {
                ...
                {
                    CallBase = true,
                    DoLocalSourceExecuteIStoreTransactionScope = (ts) =>
                    {
                        throw new StoreException("", ShardMapFaultHandlingTests.TransientSqlException);
                    }
                };
    ...
    public void AddPointMappingAbortGSMDoAndGSMUndo()
    {
        ...
        var p2 = lsm.CreatePointMapping(2, s2);
        Assert.IsNotNull(p2);
    ...
    public void SplitRangeMappingAbortGSMPostLocalDoAndGSMPostLocalUndo()
    {
        ...
        try
        {
            var rList = rsm.SplitMapping(r1, 10);
        }
        catch (ShardManagementException sme)
        {
            Assert.AreEqual(ShardManagementErrorCategory.RangeShardMap, sme.ErrorCategory);
        ...
        var rValidateLeft = rsm.GetMappingForKey(5);
        var rValidateRight = rsm.GetMappingForKey(15);
    ...
    public void MergeRangeMappingAbortSourceLocalDoAndGSMPostLocalUndo()
    {
        ...
        var r1 = rsm.CreateRangeMapping(new Range<int>(1, 20), s);
        var r2 = rsm.CreateRangeMapping(new Range<int>(20, 40), s);
        ...
        // Validation: Mapping range is not updated - lookup for point 10 returns mapping with version 0.
        var rValidateLeft = rsm.GetMappingForKey(5);
        var rValidateRight = rsm.GetMappingForKey(25);
        Assert.AreEqual(r1.Range, rValidateLeft.Range);
