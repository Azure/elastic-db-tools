...
public class SchemaInfoCollectionTests
{
    ...
    public void TestAddAndLookupAndDeleteSchemaInfo()
    {
        ...
        var siCollection = shardMapManager.GetSchemaInfoCollection();

        var si = new SchemaInfo();

        var stmd1 = new ShardedTableInfo("ShardedTableName1", "ColumnName");
        var stmd2 = new ShardedTableInfo("dbo", "ShardedTableName2", "ColumnName");
        ...
        var rtmd1 = new ReferenceTableInfo("ReferenceTableName1");
        var rtmd2 = new ReferenceTableInfo("dbo", "ReferenceTableName2");
        ...
        var siex = AssertExtensions.AssertThrows<SchemaInfoException>(
        ...
        var arex = AssertExtensions.AssertThrows<ArgumentException>(
            () => si.Add((ShardedTableInfo)null));

        arex = AssertExtensions.AssertThrows<ArgumentException>(
            () => si.Add((ReferenceTableInfo)null));

        var mdName = string.Format("TestSI_{0}", Guid.NewGuid());
        siCollection.Add(mdName, si);

        var sdmdRead = siCollection.Get(mdName);
    ...
    public void TestSetSchemaInfoWithSpecialChars()
    {
        ...
        var sti = new ShardedTableInfo(NewNameWithSpecialChars(), NewNameWithSpecialChars());
    ...
    public void TestUpdateSchemaInfo()
    {
        ...
        var sti = new ShardedTableInfo("dbo", "ShardedTableName1", "ColumnName");

        si.Add(sti);

        var rtmd = new ReferenceTableInfo("ReferenceTableName1");
    ...
    public void TestGetAll()
    {
        ...
        var i = 0;
        var success = true;
        foreach (var kvp in siCollection)
        {
    ...
    {
        var ex = new SchemaInfoException(SchemaInfoErrorCode.SchemaInfoNameConflict, "message");
    ...
    public void SerializeCompatibility()
    {
        ...
        var expectedSerializedSchemaInfo = @"<?xml version=""1.0"" encoding=""utf-16""?>
  ...
  <ShardedTableSet xmlns="""" i:type=""ArrayOfShardedTableInfo"">
    <ShardedTableInfo>
      ...
      <KeyColumnName>s3</KeyColumnName>
        ...
        var actualSerializedSchemaInfo = ToXml(schemaInfo);
        Assert.AreEqual(
            expectedSerializedSchemaInfo,
            actualSerializedSchemaInfo);

        // Deserialize it back as a sanity check
        var finalSchemaInfo = FromXml(actualSerializedSchemaInfo);
    ...
    public void DeserializeCompatibilityV100()
    {
        ...
        var originalSchemaInfo = @"<Schema xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"">
  ...
  <ShardedTableSet i:type=""ArrayOfShardedTableInfo"">
    <ShardedTableInfo>
      ...
      <KeyColumnName>s3</KeyColumnName>
        ...
        var schemaInfo = FromXml(originalSchemaInfo);
        ...
        var expectedFinalSchemaInfo = @"<?xml version=""1.0"" encoding=""utf-16""?>
<Schema xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"">
  <ReferenceTableSet xmlns="""" i:type=""ArrayOfReferenceTableInfo"">
    <ReferenceTableInfo>
      <SchemaName>r1</SchemaName>
  ...
  <ShardedTableSet xmlns="""" i:type=""ArrayOfShardedTableInfo"">
    <ShardedTableInfo>
      ...
      <KeyColumnName>s3</KeyColumnName>
        ...
        var actualFinalSchemaInfo = ToXml(schemaInfo);
...
<Schema xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"">
  ...
  <ShardedTableSet xmlns="""" i:type=""ArrayOfShardedTableInfo"">
    ...
    private string ToXml(SchemaInfo schemaInfo)
    {
        ...
        {
            var serializer = new DataContractSerializer(typeof(SchemaInfo));
    ...
    {
        using var sr = new StringReader(schemaInfo);
