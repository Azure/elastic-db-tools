...
{
    public const int max32 = 0x7FFFFFFF;
    public const long max64 = 0x7FFFFFFFFFFFFFFF;
    public ShardKey maxNonNullKey32 = new(max32);
    public ShardKey maxNonNullKey64 = new(max64);
    public Random rValGen = new();
    ...
    public void ShardKeyTests()
    {
        ...
        _ = AssertExtensions.AssertThrows<InvalidOperationException>(() => key.GetNextKey());
        ...
        Debug.Assert(result == new ShardKey(int.MinValue + 1));

        result = ShardKey.MinInt64.GetNextKey();
        Debug.Assert(result == new ShardKey(long.MinValue + 1));
