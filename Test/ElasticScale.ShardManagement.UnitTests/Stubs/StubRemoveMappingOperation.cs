...
internal class StubRemoveMappingOperation : RemoveMappingOperation
{
    ...
    protected override ShardManagementErrorCategory ErrorCategory
    {
        get
        {
            ...
            return func1 != null
                ...
                : CallBase
                ? base.ErrorCategory
                : InstanceBehavior.Result<StubRemoveMappingOperation, ShardManagementErrorCategory>(this, "get_ErrorCategory");
        }
    }
    ...
    protected override ShardLocation ErrorSourceLocation
    {
        get
        {
            ...
            return func1 != null
                ...
                : InstanceBehavior.Result<StubRemoveMappingOperation, ShardLocation>(this, "get_ErrorSourceLocation");
        }
    }
    ...
    protected override ShardLocation ErrorTargetLocation
    {
        get
        {
            ...
            return func1 != null
                ...
                : InstanceBehavior.Result<StubRemoveMappingOperation, ShardLocation>(this, "get_ErrorTargetLocation");
        }
    }
    ...
    public StubRemoveMappingOperation(ShardMapManager shardMapManager, StoreOperationCode operationCode, IStoreShardMap shardMap, IStoreMapping mapping, Guid lockOwnerId)
      : base(shardMapManager, operationCode, shardMap, mapping, lockOwnerId) => InitializeStub();
    ...
    protected override void Dispose(bool disposing)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubRemoveMappingOperation>(this, "Dispose");
    }
    ...
    public override IStoreResults DoGlobalPostLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubRemoveMappingOperation, IStoreResults>(this, "DoGlobalPostLocalExecute");
    }
    ...
    public override void DoGlobalPostLocalUpdateCache(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubRemoveMappingOperation>(this, "DoGlobalPostLocalUpdateCache");
    }
    ...
    public override IStoreResults DoGlobalPreLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubRemoveMappingOperation, IStoreResults>(this, "DoGlobalPreLocalExecute");
    }
    ...
    public override IStoreResults DoLocalSourceExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubRemoveMappingOperation, IStoreResults>(this, "DoLocalSourceExecute");
    }
    ...
    public override IStoreResults DoLocalTargetExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubRemoveMappingOperation, IStoreResults>(this, "DoLocalTargetExecute");
    }
    ...
    public override StoreConnectionInfo GetStoreConnectionInfo()
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubRemoveMappingOperation, StoreConnectionInfo>(this, "GetStoreConnectionInfo");
    }
    ...
    public override void HandleDoGlobalPostLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubRemoveMappingOperation>(this, "HandleDoGlobalPostLocalExecuteError");
    }
    ...
    public override void HandleDoGlobalPreLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubRemoveMappingOperation>(this, "HandleDoGlobalPreLocalExecuteError");
    }
    ...
    public override void HandleDoLocalSourceExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubRemoveMappingOperation>(this, "HandleDoLocalSourceExecuteError");
    }
    ...
    public override void HandleDoLocalTargetExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubRemoveMappingOperation>(this, "HandleDoLocalTargetExecuteError");
    }
    ...
    public override void HandleUndoGlobalPostLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubRemoveMappingOperation>(this, "HandleUndoGlobalPostLocalExecuteError");
    }
    ...
    public override void HandleUndoGlobalPreLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubRemoveMappingOperation>(this, "HandleUndoGlobalPreLocalExecuteError");
    }
    ...
    public override void HandleUndoLocalSourceExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubRemoveMappingOperation>(this, "HandleUndoLocalSourceExecuteError");
    }
    ...
    public override void HandleUndoLocalTargetExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubRemoveMappingOperation>(this, "HandleUndoLocalTargetExecuteError");
    }
    ...
    public override ShardManagementException OnStoreException(StoreException se, StoreOperationState state)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubRemoveMappingOperation, ShardManagementException>(this, "OnStoreException");
    }
    ...
    public override IStoreResults UndoGlobalPostLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubRemoveMappingOperation, IStoreResults>(this, "UndoGlobalPostLocalExecute");
    }
    ...
    public override IStoreResults UndoGlobalPreLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubRemoveMappingOperation, IStoreResults>(this, "UndoGlobalPreLocalExecute");
    }
    ...
    public override IStoreResults UndoLocalSourceExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubRemoveMappingOperation, IStoreResults>(this, "UndoLocalSourceExecute");
    }
    ...
    public override IStoreResults UndoLocalTargetExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubRemoveMappingOperation, IStoreResults>(this, "UndoLocalTargetExecute");
    }
}
