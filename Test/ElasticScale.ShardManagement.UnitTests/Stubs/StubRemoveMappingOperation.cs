...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.UnitTests.Stubs
{
    ...
    /// </summary>
    [StubClass(typeof(RemoveMappingOperation))]
    [DebuggerDisplay("Stub of RemoveMappingOperation")]
    [DebuggerNonUserCode]
    internal class StubRemoveMappingOperation : RemoveMappingOperation, IStub<RemoveMappingOperation>, IStub, IStubObservable, IPartialStub
    {
        /// <summary>
        ...
        protected override ShardManagementErrorCategory ErrorCategory
        {
            get
            {
                ...
                {
                    FakesDelegates.Func<ShardManagementErrorCategory> func = (FakesDelegates.Func<ShardManagementErrorCategory>)StubRuntime.BindProperty(typeof(FakesDelegates.Func<ShardManagementErrorCategory>), (object)this, typeof(RemoveMappingOperation), "ErrorCategory", true, typeof(ShardManagementErrorCategory));
                    instanceObserver.Enter(typeof(RemoveMappingOperation), (Delegate)func);
                }
        ...
        protected override ShardLocation ErrorSourceLocation
        {
            get
            {
                ...
                if (instanceObserver != null)
                {
                    FakesDelegates.Func<ShardLocation> func = (FakesDelegates.Func<ShardLocation>)StubRuntime.BindProperty(typeof(FakesDelegates.Func<ShardLocation>), (object)this, typeof(RemoveMappingOperation), "ErrorSourceLocation", true, typeof(ShardLocation));
                    instanceObserver.Enter(typeof(RemoveMappingOperation), (Delegate)func);
                }
        ...
        protected override ShardLocation ErrorTargetLocation
        {
            get
            {
                ...
                if (instanceObserver != null)
                {
                    FakesDelegates.Func<ShardLocation> func = (FakesDelegates.Func<ShardLocation>)StubRuntime.BindProperty(typeof(FakesDelegates.Func<ShardLocation>), (object)this, typeof(RemoveMappingOperation), "ErrorTargetLocation", true, typeof(ShardLocation));
                    instanceObserver.Enter(typeof(RemoveMappingOperation), (Delegate)func);
                }
        ...
        public override IStoreResults DoGlobalPostLocalExecute(IStoreTransactionScope ts)
        {
            ...
            if (instanceObserver != null)
            {
                ...
                instanceObserver.Enter(typeof(RemoveMappingOperation), (Delegate)func, (object)ts);
            }
        ...
        public override void DoGlobalPostLocalUpdateCache(IStoreResults result)
        {
            ...
            if (instanceObserver != null)
            {
                ...
                instanceObserver.Enter(typeof(RemoveMappingOperation), (Delegate)action, (object)result);
            }
