...
internal class StubUpdateMappingOperation : UpdateMappingOperation
{
    ...
    protected override ShardManagementErrorCategory ErrorCategory
    {
        get
        {
            ...
            return func1 != null
                ...
                : CallBase
                ? base.ErrorCategory
                : InstanceBehavior.Result<StubUpdateMappingOperation, ShardManagementErrorCategory>(this, "get_ErrorCategory");
        }
    }
    ...
    protected override ShardLocation ErrorSourceLocation
    {
        get
        {
            ...
            return func1 != null
                ...
                : InstanceBehavior.Result<StubUpdateMappingOperation, ShardLocation>(this, "get_ErrorSourceLocation");
        }
    }
    ...
    protected override ShardLocation ErrorTargetLocation
    {
        get
        {
            ...
            return func1 != null
                ...
                : InstanceBehavior.Result<StubUpdateMappingOperation, ShardLocation>(this, "get_ErrorTargetLocation");
        }
    }
    ...
    public StubUpdateMappingOperation(ShardMapManager shardMapManager, StoreOperationCode operationCode, IStoreShardMap shardMap, IStoreMapping mappingSource, IStoreMapping mappingTarget, string patternForKill, Guid lockOwnerId, bool killConnection)
      : base(shardMapManager, operationCode, shardMap, mappingSource, mappingTarget, patternForKill, lockOwnerId, killConnection) => InitializeStub();
    ...
    protected override void Dispose(bool disposing)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "Dispose");
    }
    ...
    public override IStoreResults DoGlobalPostLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "DoGlobalPostLocalExecute");
    }
    ...
    public override void DoGlobalPostLocalUpdateCache(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "DoGlobalPostLocalUpdateCache");
    }
    ...
    public override IStoreResults DoGlobalPreLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "DoGlobalPreLocalExecute");
    }
    ...
    public override IStoreResults DoLocalSourceExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "DoLocalSourceExecute");
    }
    ...
    public override IStoreResults DoLocalTargetExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "DoLocalTargetExecute");
    }
    ...
    public override StoreConnectionInfo GetStoreConnectionInfo()
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubUpdateMappingOperation, StoreConnectionInfo>(this, "GetStoreConnectionInfo");
    }
    ...
    public override void HandleDoGlobalPostLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleDoGlobalPostLocalExecuteError");
    }
    ...
    public override void HandleDoGlobalPreLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleDoGlobalPreLocalExecuteError");
    }
    ...
    public override void HandleDoLocalSourceExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleDoLocalSourceExecuteError");
    }
    ...
    public override void HandleDoLocalTargetExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleDoLocalTargetExecuteError");
    }
    ...
    public override void HandleUndoGlobalPostLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleUndoGlobalPostLocalExecuteError");
    }
    ...
    public override void HandleUndoGlobalPreLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleUndoGlobalPreLocalExecuteError");
    }
    ...
    public override void HandleUndoLocalSourceExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleUndoLocalSourceExecuteError");
    }
    ...
    public override void HandleUndoLocalTargetExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleUndoLocalTargetExecuteError");
    }
    ...
    public override ShardManagementException OnStoreException(StoreException se, StoreOperationState state)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubUpdateMappingOperation, ShardManagementException>(this, "OnStoreException");
    }
    ...
    public override IStoreResults UndoGlobalPostLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "UndoGlobalPostLocalExecute");
    }
    ...
    public override IStoreResults UndoGlobalPreLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "UndoGlobalPreLocalExecute");
    }
    ...
    public override IStoreResults UndoLocalSourceExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "UndoLocalSourceExecute");
    }
    ...
    public override IStoreResults UndoLocalTargetExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "UndoLocalTargetExecute");
    }
}
