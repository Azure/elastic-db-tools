...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.UnitTests.Stubs
{
    ...
    /// </summary>
    [StubClass(typeof(UpdateMappingOperation))]
    [DebuggerDisplay("Stub of UpdateMappingOperation")]
    [DebuggerNonUserCode]
    internal class StubUpdateMappingOperation : UpdateMappingOperation, IStub<UpdateMappingOperation>, IStub, IStubObservable, IPartialStub
    {
        /// <summary>
        ...
        protected override ShardManagementErrorCategory ErrorCategory
        {
            get
            {
                ...
                {
                    FakesDelegates.Func<ShardManagementErrorCategory> func = (FakesDelegates.Func<ShardManagementErrorCategory>)StubRuntime.BindProperty(typeof(FakesDelegates.Func<ShardManagementErrorCategory>), (object)this, typeof(UpdateMappingOperation), "ErrorCategory", true, typeof(ShardManagementErrorCategory));
                    instanceObserver.Enter(typeof(UpdateMappingOperation), (Delegate)func);
                }
        ...
        protected override ShardLocation ErrorSourceLocation
        {
            get
            {
                ...
                if (instanceObserver != null)
                {
                    FakesDelegates.Func<ShardLocation> func = (FakesDelegates.Func<ShardLocation>)StubRuntime.BindProperty(typeof(FakesDelegates.Func<ShardLocation>), (object)this, typeof(UpdateMappingOperation), "ErrorSourceLocation", true, typeof(ShardLocation));
                    instanceObserver.Enter(typeof(UpdateMappingOperation), (Delegate)func);
                }
        ...
        protected override ShardLocation ErrorTargetLocation
        {
            get
            {
                ...
                if (instanceObserver != null)
                {
                    FakesDelegates.Func<ShardLocation> func = (FakesDelegates.Func<ShardLocation>)StubRuntime.BindProperty(typeof(FakesDelegates.Func<ShardLocation>), (object)this, typeof(UpdateMappingOperation), "ErrorTargetLocation", true, typeof(ShardLocation));
                    instanceObserver.Enter(typeof(UpdateMappingOperation), (Delegate)func);
                }
        ...
        public override IStoreResults DoGlobalPostLocalExecute(IStoreTransactionScope ts)
        {
            ...
            if (instanceObserver != null)
            {
                ...
                instanceObserver.Enter(typeof(UpdateMappingOperation), (Delegate)func, (object)ts);
            }
        ...
        public override void DoGlobalPostLocalUpdateCache(IStoreResults result)
        {
            ...
            if (instanceObserver != null)
            {
                ...
                instanceObserver.Enter(typeof(UpdateMappingOperation), (Delegate)action, (object)result);
            }
