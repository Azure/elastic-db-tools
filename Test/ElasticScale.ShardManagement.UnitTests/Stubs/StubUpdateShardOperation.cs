...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.UnitTests.Stubs
{
    ...
    /// </summary>
    [StubClass(typeof(UpdateShardOperation))]
    [DebuggerDisplay("Stub of UpdateShardOperation")]
    [DebuggerNonUserCode]
    internal class StubUpdateShardOperation : UpdateShardOperation, IStub<UpdateShardOperation>, IStub, IStubObservable, IPartialStub
    {
        /// <summary>
        ...
        protected override ShardManagementErrorCategory ErrorCategory
        {
            get
            {
                ...
                {
                    FakesDelegates.Func<ShardManagementErrorCategory> func = (FakesDelegates.Func<ShardManagementErrorCategory>)StubRuntime.BindProperty(typeof(FakesDelegates.Func<ShardManagementErrorCategory>), (object)this, typeof(UpdateShardOperation), "ErrorCategory", true, typeof(ShardManagementErrorCategory));
                    instanceObserver.Enter(typeof(UpdateShardOperation), (Delegate)func);
                }
        ...
        protected override ShardLocation ErrorSourceLocation
        {
            get
            {
                ...
                if (instanceObserver != null)
                {
                    FakesDelegates.Func<ShardLocation> func = (FakesDelegates.Func<ShardLocation>)StubRuntime.BindProperty(typeof(FakesDelegates.Func<ShardLocation>), (object)this, typeof(UpdateShardOperation), "ErrorSourceLocation", true, typeof(ShardLocation));
                    instanceObserver.Enter(typeof(UpdateShardOperation), (Delegate)func);
                }
        ...
        protected override ShardLocation ErrorTargetLocation
        {
            get
            {
                ...
                if (instanceObserver != null)
                {
                    FakesDelegates.Func<ShardLocation> func = (FakesDelegates.Func<ShardLocation>)StubRuntime.BindProperty(typeof(FakesDelegates.Func<ShardLocation>), (object)this, typeof(UpdateShardOperation), "ErrorTargetLocation", true, typeof(ShardLocation));
                    instanceObserver.Enter(typeof(UpdateShardOperation), (Delegate)func);
                }
        ...
        public override IStoreResults DoGlobalPostLocalExecute(IStoreTransactionScope ts)
        {
            ...
            if (instanceObserver != null)
            {
                ...
                instanceObserver.Enter(typeof(UpdateShardOperation), (Delegate)func, (object)ts);
            }
        ...
        public override void HandleDoGlobalPostLocalExecuteError(IStoreResults result)
        {
            ...
            if (instanceObserver != null)
            {
                ...
                instanceObserver.Enter(typeof(UpdateShardOperation), (Delegate)action, (object)result);
            }
