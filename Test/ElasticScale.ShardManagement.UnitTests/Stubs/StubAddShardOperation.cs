...
internal class StubAddShardOperation : AddShardOperation
{
    ...
    protected override ShardManagementErrorCategory ErrorCategory
    {
        get
        {
            ...
            return func1 != null
                ...
                : CallBase
                ? base.ErrorCategory
                : InstanceBehavior.Result<StubAddShardOperation, ShardManagementErrorCategory>(this, "get_ErrorCategory");
        }
    }
    ...
    protected override ShardLocation ErrorSourceLocation
    {
        get
        {
            ...
            return func1 != null
                ...
                : InstanceBehavior.Result<StubAddShardOperation, ShardLocation>(this, "get_ErrorSourceLocation");
        }
    }
    ...
    protected override ShardLocation ErrorTargetLocation
    {
        get
        {
            ...
            return func1 != null
                ...
                : InstanceBehavior.Result<StubAddShardOperation, ShardLocation>(this, "get_ErrorTargetLocation");
        }
    }
    ...
    protected override void Dispose(bool disposing)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubAddShardOperation>(this, "Dispose");
    }
    ...
    public override IStoreResults DoGlobalPostLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubAddShardOperation, IStoreResults>(this, "DoGlobalPostLocalExecute");
    }
    ...
    public override void DoGlobalPostLocalUpdateCache(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubAddShardOperation>(this, "DoGlobalPostLocalUpdateCache");
    }
    ...
    public override IStoreResults DoGlobalPreLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubAddShardOperation, IStoreResults>(this, "DoGlobalPreLocalExecute");
    }
    ...
    public override IStoreResults DoLocalSourceExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubAddShardOperation, IStoreResults>(this, "DoLocalSourceExecute");
    }
    ...
    public override IStoreResults DoLocalTargetExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubAddShardOperation, IStoreResults>(this, "DoLocalTargetExecute");
    }
    ...
    public override StoreConnectionInfo GetStoreConnectionInfo()
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubAddShardOperation, StoreConnectionInfo>(this, "GetStoreConnectionInfo");
    }
    ...
    public override void HandleDoGlobalPostLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubAddShardOperation>(this, "HandleDoGlobalPostLocalExecuteError");
    }
    ...
    public override void HandleDoGlobalPreLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubAddShardOperation>(this, "HandleDoGlobalPreLocalExecuteError");
    }
    ...
    public override void HandleDoLocalSourceExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubAddShardOperation>(this, "HandleDoLocalSourceExecuteError");
    }
    ...
    public override void HandleDoLocalTargetExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubAddShardOperation>(this, "HandleDoLocalTargetExecuteError");
    }
    ...
    public override void HandleUndoGlobalPostLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubAddShardOperation>(this, "HandleUndoGlobalPostLocalExecuteError");
    }
    ...
    public override void HandleUndoGlobalPreLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubAddShardOperation>(this, "HandleUndoGlobalPreLocalExecuteError");
    }
    ...
    public override void HandleUndoLocalSourceExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubAddShardOperation>(this, "HandleUndoLocalSourceExecuteError");
    }
    ...
    public override void HandleUndoLocalTargetExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubAddShardOperation>(this, "HandleUndoLocalTargetExecuteError");
    }
    ...
    public override ShardManagementException OnStoreException(StoreException se, StoreOperationState state)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubAddShardOperation, ShardManagementException>(this, "OnStoreException");
    }
    ...
    public override IStoreResults UndoGlobalPostLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubAddShardOperation, IStoreResults>(this, "UndoGlobalPostLocalExecute");
    }
    ...
    public override IStoreResults UndoGlobalPreLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubAddShardOperation, IStoreResults>(this, "UndoGlobalPreLocalExecute");
    }
    ...
    public override IStoreResults UndoLocalSourceExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubAddShardOperation, IStoreResults>(this, "UndoLocalSourceExecute");
    }
    ...
    public override IStoreResults UndoLocalTargetExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubAddShardOperation, IStoreResults>(this, "UndoLocalTargetExecute");
    }
}
