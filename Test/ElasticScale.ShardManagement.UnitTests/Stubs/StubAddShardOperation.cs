...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.UnitTests.Stubs
{
    ...
    /// </summary>
    [StubClass(typeof(AddShardOperation))]
    [DebuggerDisplay("Stub of AddShardOperation")]
    [DebuggerNonUserCode]
    internal class StubAddShardOperation : AddShardOperation, IStub<AddShardOperation>, IStub, IStubObservable, IPartialStub
    {
        /// <summary>
        ...
        protected override ShardManagementErrorCategory ErrorCategory
        {
            get
            {
                ...
                {
                    FakesDelegates.Func<ShardManagementErrorCategory> func = (FakesDelegates.Func<ShardManagementErrorCategory>)StubRuntime.BindProperty(typeof(FakesDelegates.Func<ShardManagementErrorCategory>), (object)this, typeof(AddShardOperation), "ErrorCategory", true, typeof(ShardManagementErrorCategory));
                    instanceObserver.Enter(typeof(AddShardOperation), (Delegate)func);
                }
        ...
        protected override ShardLocation ErrorSourceLocation
        {
            get
            {
                ...
                if (instanceObserver != null)
                {
                    FakesDelegates.Func<ShardLocation> func = (FakesDelegates.Func<ShardLocation>)StubRuntime.BindProperty(typeof(FakesDelegates.Func<ShardLocation>), (object)this, typeof(AddShardOperation), "ErrorSourceLocation", true, typeof(ShardLocation));
                    instanceObserver.Enter(typeof(AddShardOperation), (Delegate)func);
                }
        ...
        protected override ShardLocation ErrorTargetLocation
        {
            get
            {
                ...
                if (instanceObserver != null)
                {
                    FakesDelegates.Func<ShardLocation> func = (FakesDelegates.Func<ShardLocation>)StubRuntime.BindProperty(typeof(FakesDelegates.Func<ShardLocation>), (object)this, typeof(AddShardOperation), "ErrorTargetLocation", true, typeof(ShardLocation));
                    instanceObserver.Enter(typeof(AddShardOperation), (Delegate)func);
                }
        ...
        public override IStoreResults DoGlobalPostLocalExecute(IStoreTransactionScope ts)
        {
            ...
            if (instanceObserver != null)
            {
                ...
                instanceObserver.Enter(typeof(AddShardOperation), (Delegate)func, (object)ts);
            }
        ...
        public override void HandleDoGlobalPostLocalExecuteError(IStoreResults result)
        {
            ...
            if (instanceObserver != null)
            {
                ...
                instanceObserver.Enter(typeof(AddShardOperation), (Delegate)action, (object)result);
            }
