...
internal class StubReplaceMappingsOperation : ReplaceMappingsOperation
{
    ...
    protected override ShardManagementErrorCategory ErrorCategory
    {
        get
        {
            ...
            return func1 != null
                ...
                : CallBase
                ? base.ErrorCategory
                : InstanceBehavior.Result<StubReplaceMappingsOperation, ShardManagementErrorCategory>(this, "get_ErrorCategory");
        }
    }
    ...
    protected override ShardLocation ErrorSourceLocation
    {
        get
        {
            ...
            return func1 != null
                ...
                : InstanceBehavior.Result<StubReplaceMappingsOperation, ShardLocation>(this, "get_ErrorSourceLocation");
        }
    }
    ...
    protected override ShardLocation ErrorTargetLocation
    {
        get
        {
            ...
            return func1 != null
                ...
                : InstanceBehavior.Result<StubReplaceMappingsOperation, ShardLocation>(this, "get_ErrorTargetLocation");
        }
    }
    ...
    public StubReplaceMappingsOperation(ShardMapManager shardMapManager, StoreOperationCode operationCode, IStoreShardMap shardMap, Tuple<IStoreMapping, Guid>[] mappingsSource, Tuple<IStoreMapping, Guid>[] mappingsTarget)
      : base(shardMapManager, operationCode, shardMap, mappingsSource, mappingsTarget) => InitializeStub();
    ...
    protected override void Dispose(bool disposing)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubReplaceMappingsOperation>(this, "Dispose");
    }
    ...
    public override IStoreResults DoGlobalPostLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubReplaceMappingsOperation, IStoreResults>(this, "DoGlobalPostLocalExecute");
    }
    ...
    public override void DoGlobalPostLocalUpdateCache(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubReplaceMappingsOperation>(this, "DoGlobalPostLocalUpdateCache");
    }
    ...
    public override IStoreResults DoGlobalPreLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubReplaceMappingsOperation, IStoreResults>(this, "DoGlobalPreLocalExecute");
    }
    ...
    public override IStoreResults DoLocalSourceExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubReplaceMappingsOperation, IStoreResults>(this, "DoLocalSourceExecute");
    }
    ...
    public override IStoreResults DoLocalTargetExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubReplaceMappingsOperation, IStoreResults>(this, "DoLocalTargetExecute");
    }
    ...
    public override StoreConnectionInfo GetStoreConnectionInfo()
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubReplaceMappingsOperation, StoreConnectionInfo>(this, "GetStoreConnectionInfo");
    }
    ...
    public override void HandleDoGlobalPostLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubReplaceMappingsOperation>(this, "HandleDoGlobalPostLocalExecuteError");
    }
    ...
    public override void HandleDoGlobalPreLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubReplaceMappingsOperation>(this, "HandleDoGlobalPreLocalExecuteError");
    }
    ...
    public override void HandleDoLocalSourceExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubReplaceMappingsOperation>(this, "HandleDoLocalSourceExecuteError");
    }
    ...
    public override void HandleDoLocalTargetExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubReplaceMappingsOperation>(this, "HandleDoLocalTargetExecuteError");
    }
    ...
    public override void HandleUndoGlobalPostLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubReplaceMappingsOperation>(this, "HandleUndoGlobalPostLocalExecuteError");
    }
    ...
    public override void HandleUndoGlobalPreLocalExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubReplaceMappingsOperation>(this, "HandleUndoGlobalPreLocalExecuteError");
    }
    ...
    public override void HandleUndoLocalSourceExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubReplaceMappingsOperation>(this, "HandleUndoLocalSourceExecuteError");
    }
    ...
    public override void HandleUndoLocalTargetExecuteError(IStoreResults result)
    {
        ...
        if (action1 != null)
            ...
            InstanceBehavior.VoidResult<StubReplaceMappingsOperation>(this, "HandleUndoLocalTargetExecuteError");
    }
    ...
    public override ShardManagementException OnStoreException(StoreException se, StoreOperationState state)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubReplaceMappingsOperation, ShardManagementException>(this, "OnStoreException");
    }
    ...
    public override IStoreResults UndoGlobalPostLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubReplaceMappingsOperation, IStoreResults>(this, "UndoGlobalPostLocalExecute");
    }
    ...
    public override IStoreResults UndoGlobalPreLocalExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubReplaceMappingsOperation, IStoreResults>(this, "UndoGlobalPreLocalExecute");
    }
    ...
    public override IStoreResults UndoLocalSourceExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubReplaceMappingsOperation, IStoreResults>(this, "UndoLocalSourceExecute");
    }
    ...
    public override IStoreResults UndoLocalTargetExecute(IStoreTransactionScope ts)
    {
        ...
        return func1 != null
            ...
            : InstanceBehavior.Result<StubReplaceMappingsOperation, IStoreResults>(this, "UndoLocalTargetExecute");
    }
}
