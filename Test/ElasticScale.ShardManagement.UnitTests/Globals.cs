...
internal static class Globals
{
    ...
    private const string ShardMapManagerConnStringBase =
        @"Data Source=" + Globals.ShardMapManagerTestsDatasourceName + ";Initial Catalog=ShardMapManager;TrustServerCertificate=true;";
    ...
    /// </summary>
    internal static string ShardMapManagerConnectionString => Globals.ShardMapManagerConnString;
    ...
    internal static SqlCredential ShardUserCredentialForSqlAuth(string username) =>
        new(username, GenerateSecureString(SqlLoginTestPassword));
