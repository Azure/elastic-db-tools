...
internal class Program
{
    ...
    private static readonly string s_server = "[YourSQLServerName]";
    private static readonly string s_shardmapmgrdb = "[YourShardMapManagerDatabaseName]";
    private static readonly string s_shard1 = "[YourShard01DatabaseName]";
    private static readonly string s_shard2 = "[YourShard02DatabaseName]";
    private static readonly string s_userName = "[YourUserName]";
    private static readonly string s_password = "[YourPassword]";
    private static readonly string s_applicationName = "ESC_EFMTv1.0";

    // Four tenants
    private static readonly int s_tenantId1 = 1;
    private static readonly int s_tenantId2 = 2;
    private static readonly int s_tenantId3 = 3;
    private static readonly int s_tenantId4 = 4;
    ...
    public static void Main()
    {
        ...
        var sharding = new Sharding(s_server, s_shardmapmgrdb, connStrBldr.ConnectionString);
        ...
        var tenants = new int[] { s_tenantId1, s_tenantId2, s_tenantId3, s_tenantId4 };
        ...
        SqlDatabaseUtils.SqlRetryPolicy.ExecuteAction(() =>
        {
            ...
            using var conn = ElasticScaleContext<int>.OpenDDRConnection(sharding.ShardMap, s_tenantId4, connStrBldr.ConnectionString);
